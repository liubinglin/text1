...
<!-- end banner_x -->
	...
	<div class="xiangqing">
		<div class="neirong w">
			...
			<div class="xiaomi6 fl">${product.productname}</div>
			<nav class="fr">
				<li><a href="">概述</a></li>
				<li>|</li>
				<li><a href="">变焦双摄</a></li>
...
<form action="gouwu" method="post">
	<div class="jieshao mt20 w">
			<input type="hidden" name="productname" value="${product.productname}">
			<input type="hidden" name="loginName" value="${qiantailogin.loginName}">
			<input type="hidden" name="productld" value="${product.id}">
			<input type="hidden" name="price" value="${product.price}">
		<div class="left fl"><img src="${product.fileName}"></div>
		<div class="right fr">
			...
			<div class="xqxq mt20 ml20">
				<div class="top1 mt10">
					<div class="left1 fl">${product.description}</div>
					<div class="right1 fr" >${product.price}</div>
					<div class="clear"></div>
				</div>
				<div class="bot mt20 ft20 ftbc">${product.price}</div>
			</div>
