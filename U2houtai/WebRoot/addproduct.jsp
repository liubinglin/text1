	...
	<body>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<form class="form-horizontal"  enctype="multipart/form-data"  action="addproduct" method="post">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" name="productname"/>				
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" name="description"/>				
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" name="stock"/>				
										</div>
									</div>
									...
									<div class="form-group">
										...
										<select style="margin-left:15px;" id="fenlei" onchange="gradeChange()" name="categoryLevel1">
