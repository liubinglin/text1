				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li class="active open">
							...
							<li>
							<a href="updatenews.jsp"> <i class="icon-double-angle-right">
								</i> 新闻详情</a>
							 </li>
							 <li>
							<a href="addnews.jsp"> <i class="icon-double-angle-right">
								</i> 添加新闻</a>
							 </li>
							</ul>
						</li>
				...
				$(data).each(function(){
					...
					$("#tbody").append("<tr>"+
										...
										"</td>"+
											"<td>"+this.id+"</td>"+
											"<td>"+this.title+"</td>"+
											"<td class='hidden-480'>"+this.content+"</td>"+	
											"<td class='hidden-480'>"+this.createTime+"</td>"+													
											"<td>"+
												"<div class='visible-md visible-lg hidden-sm hidden-xs btn-group'>"+
													"<button class='btn btn-xs btn-success' onclick=chakan('showNewsServlet?id="+this.id+"');>"+
														 "<input type='hidden' id='chakan' >"+
															"<i class='icon-ok bigger-120' >查看</i>"+
													"</button>"+
													"<button class='btn btn-xs btn-info' onclick=chakan('showNewsServlet?id="+this.id+"');>"+
														  "<i class='icon-edit bigger-120'>编辑</i>"+
													"</button>"+
														 "<button class='btn btn-xs btn-danger' onclick=shanchu('deleteNewsServlet?id="+this.id+"');>"+
																	"<i class='icon-trash bigger-120'>删除</i>"+
																"</button>"+
													"</div>"+
