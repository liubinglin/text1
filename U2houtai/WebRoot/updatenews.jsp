						...
						<div class="row">
							<div class="col-xs-12">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" value="${updateNews.id}" name="id" readonly unselectable="on" />				
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" value="${updateNews.title}" name="title"/>				
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" rows="3"  style="width: 350px;height: 150px;" name="content">${updateNews.content}</textarea>
										</div>
									</div>
										<select name="categoryLevel1" id="select">
										<option value="1">手机电话卡</option>
