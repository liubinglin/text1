					...
					$(data).each(function(){
						if(this.status==1){
							...
							$("#tbody").append("<tr>"+
														...
														"<td >"+this.status+"</td>"+
														"<td >"+this.type+"</td>"+
														"<td >"+this.seraINumber+"</td>	"+															
														"<td>"+
															"<div class='visible-md visible-lg hidden-sm hidden-xs btn-group'>"+
																"<button class='btn btn-xs btn-success' onclick=chakan('findOne?id="+this.id+"');>"+
														 			"<input type='hidden' id='chakan' >"+
																"<i class='icon-ok bigger-120' >查看</i>"+
																"</button>"+
																"<button class='btn btn-xs btn-info' onclick=chakan('findOne?id="+this.id+"');>"+
														  		"<i class='icon-edit bigger-120'>编辑</i>"+
																"</button>"+
																"<button class='btn btn-xs btn-danger' onclick=shanchu('deleteOrder?id="+this.id+"');>"+
																"<i class='icon-trash bigger-120'>删除</i>"+
																"</button>"+
															"</div>"+
														"</td>"+
