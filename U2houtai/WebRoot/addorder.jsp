				...
				<div class="sidebar" id="sidebar">
					...
					<li class="active"><a href="index.jsp"> <i
						...
						<li class="active open">
							...
							<i class="icon-list"></i> <span class="menu-text">订单</span> 
							<b class="arrow icon-angle-down"></b>
							</a>
						<ul class="submenu">
							<li><a href="order.jsp"> 
							...
							<li><a href="updateorder.jsp"> 
							<i class="icon-double-angle-right"></i>订单详情</a>
							</li>
							<li  class="active"><a href="addorder.jsp"> 
						...
						<div class="row">
							<div class="col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" name="cost"/>				
										</div>
									</div>
									<div class="form-group">
										...
										<input type="radio" name="status" value="3">配货
										<input type="radio" name="status" value="4">已发货
										<input type="radio" name="status" value="5">已收货
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2"class="col-xs-10 col-sm-5" name="seraINumber"/>				
										</div>
									</div>
